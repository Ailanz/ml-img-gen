...
class NoisePredictor:
    ...
    def build_model(self, input_shape=(128, 128, 3), lr=0.2):
        ...
        # Expanding path
        up4 = concatenate([Conv2DTranspose(3, 3, strides=(2, 2), activation='relu', padding='same')(conv3), conv2, down1], axis=-1)
        conv4 = Conv2D(128, 3, activation='relu', padding='same')(up4)
        conv4 = BatchNormalization()(conv4)
        conv4 = Conv2D(128, 3, activation='relu', padding='same')(conv4)
        conv4 = BatchNormalization()(conv4)

        up5 = concatenate([Conv2DTranspose(3, 3, strides=(2, 2), activation='relu', padding='same')(conv4), conv1, inputs], axis=-1)
